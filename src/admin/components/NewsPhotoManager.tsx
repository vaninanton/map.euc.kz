    ...
    return (
        <div className="rounded-xl border border-neutral-200 bg-white p-4">
            ...
            <p className="mt-2 text-xs text-neutral-400">
                Фото подставляется в сообщение при рассылке. Если новость уже отправлена, заменить фото в Telegram можно
                кнопкой «Обновить текст во всех отправленных». Ограничение Telegram: заменить можно только одно фото на
                другое — добавить фото к сообщению без него или убрать фото из сообщения с ним нельзя.
            </p>
        </div>
    )
}
