...
export function PwaPrompts() {
  ...
  return (
    <>
      {waitingWorker && (
        <div className="fixed left-1/2 top-3 z-30 flex -translate-x-1/2 items-center gap-2 rounded-lg bg-neutral-900 px-3 py-2 text-xs font-medium text-white shadow-md">
