...
function Icon2GIS() {
    return <img src="/2gis-icon.png" alt="" width={20} height={20} className="rounded-[2px]" aria-hidden />
}

function IconGuru() {
    return (
        <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <g clipPath="url(#guru-clip)">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M14.0088 22.1667C16.4039 22.1667 18.5427 21.1591 20.0289 19.5404C19.4247 19.059 18.0877 17.9863 16.0178 16.3223C16.3316 15.8959 16.5548 15.5104 16.6874 15.1656C16.82 14.8208 16.9012 14.4149 16.931 13.948C20.2184 13.948 21.9637 13.948 22.1666 13.948C22.1666 9.40892 18.5478 5.79016 14.0088 5.79016C9.46968 5.79016 5.79004 9.4698 5.79004 14.0089C5.79004 18.5479 9.46968 22.1667 14.0088 22.1667Z"
                    fill="white"
                    fillOpacity="0.8"
                />
                <path
            ...
            <defs>
                ...
                >
                    <stop stopColor="#71B531" />
                    <stop offset="1" stopColor="#588D27" />
                </linearGradient>
                <linearGradient
                    id="guru-paint1"
                    x1="27.7408"
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop stopColor="#7BA0D0" />
                    <stop offset="1" stopColor="#325A8F" />
                </linearGradient>
                <clipPath id="guru-clip">
...
function IconOpenRoute() {
    return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm-1.5 9.5h3v-3h-3v3z" />
        </svg>
    )
}
