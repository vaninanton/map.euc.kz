...
export function EucMap() {
    ...
    useEffect(() => {
        ...
        if (!draftMarkerRef.current) {
            ...
            draftMarkerRef.current = new Marker({ element: markerEl, anchor: 'center' })
                .setLngLat(draftCoordinates)
                .addTo(map)
        }
    ...
    return (
        <div>
            ...
            <LiveActivityBar telegramLatestGeo={telegramLatestGeo} onPress={handleLiveActivityPress} />
            ...
            {(!selectedFeature || isDesktop) && (
                <LayerControls
                    ...
                    baseStyle={baseStyle}
                    onToggleBaseStyle={() => {
                        setBaseMapStyle(baseStyle === 'satellite' ? 'streets' : 'satellite')
                    }}
                />
            )}
            ...
            {isRouteListOpen && (
                <RouteListSidebar
                    ...
                    selectedRouteId={
                        selectedFeature?.properties.type === 'route' ? selectedFeature.properties.id : undefined
                    }
                    isDesktop={isDesktop}
                />
            )}
